...
MANAGED_AIRPORT_OPERATOR = "AIRPORT_OPERATOR"  # default is "AIRPORT_OPERATOR"
MANAGED_AIRPORT_HANDLER = "AIRPORT_HANDLER"  # default is "AIRPORT_HANDLER"
MANAGED_AIRPORT_MISSION_HANDLER = "MISSION_HANDLER"  # default is "MISSION_HANDLER"
