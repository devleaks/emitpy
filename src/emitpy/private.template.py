...
# Please visit flightplandatabase.com and flightplandb-py.readthedocs.io for details.
#
FLIGHT_PLAN_DATABASE_APIKEY = "<your-flight-plan-database-key-here>"
API_KEY = "<emitpy-api-key>"
