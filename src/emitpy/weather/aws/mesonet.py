...
logger = logging.getLogger("Mesonet")


class MESONETMetar(WebFetch):
    """
    ...
    def fetch(self):
		...
		* https://github.com/akrherz/iem/blob/main/scripts/asos/iem_scraper_example.py
        ...
        url2 = (
            url2
            + f"&year1={yr}&month1={mo}&day1={dy}&year2={yr}&month2={mo}&day2={dy}&tz=Etc%2FUTC&format=onlycomma&latlon=no&elev=no&missing=null&trace=null&direct=no&report_type=3"
        )
