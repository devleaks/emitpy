...
#
MANAGED_AIRPORT_ICAO = "EBLG"             # there is no default value
MANAGED_AIRPORT_OPERATOR = "LAO"          # default is "AIRPORT_OPERATOR"
MANAGED_AIRPORT_HANDLER = "LAH"           # default is "AIRPORT_HANDLER"
MANAGED_AIRPORT_MISSION_HANDLER = "LAS"   # default is "MISSION_HANDLER"
