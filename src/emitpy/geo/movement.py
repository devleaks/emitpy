...
class Movement(Messages):
    def __init__(self, airport: "ManagedAirportBase", reason: Messages):
        ...
        self._points: List[MovePoint] = []

        # Movement scheduling
        self._scheduled_points: List[MovePoint] = []
        self.version = 0
    ...
    def tabulateMovement(self):
        ...
        HEADER = ["INDEX", "FP INDEX", "SEGMENT NAME", "DISTANCE", "TOTAL DISTANCE", "ALT", "SPEED", "V/S", "RESTRICTION"]
        table = []
    ...
    def getBoundingBox(self, rounding: float | None = None):
        """
    ...
    def getMarkRelativeEmissionTime(self, sync: str, instance: int = -1):
        ...
        criteria: Dict[str, Any] = {FEATPROP.MARK.value: sync}
        if instance > -1:
